...
export default function ServicesClient() {
  ...
  // Instant single-click tab selection using pointerdown
  ...
  return (
    <div className="page active" id="pg-services" ref={containerRef}>
      ...
      >
        ...
        {/* STICKY HORIZONTAL TAB CONTROL TRACK BAR */}
        <div 
          ref={trackRef}
        ...
        >
          {tabs.map((tab) => (
            <button
              ...
              onPointerDown={(e) => handleTabClick(e, tab.id)}
              style={{ background: 'none', borderTop: 'none', borderLeft: 'none', borderRight: 'none', cursor: 'pointer', pointerEvents: 'auto', touchAction: 'manipulation' }}
            >
              {tab.icon}
              {tab.label}
            </button>
        ...
        {/* PANELS CONTAINER REFERENCE POINT */}
        <div ref={panelsContainerRef} style={{ marginTop: '30px', scrollMarginTop: '130px' }}>
          ...
          <div className={`spanel ${activeTab === 'audio' ? 'active' : ''}`} style={{ display: activeTab === 'audio' ? 'block' : 'none', width: '100%', paddingLeft: 'clamp(22px, 6vw, 80px)', paddingRight: 'clamp(22px, 6vw, 80px)' }}>
            <div className="sphdr reveal" style={{ width: '100%' }}>
              ...
              <div className="avwrap" style={{ width: '100%', marginTop: '30px', borderRadius: '16px', overflow: 'hidden', position: 'relative', aspectRatio: '16/9' }}>
                <Image 
                  src="https://firebasestorage.googleapis.com/v0/b/ibc-studio.appspot.com/o/Images%2FServices_main%2F1.%20audio.webp?alt=media&token=a541982f-718c-4dc2-b489-0fb24c87c334" 
                  alt="Audio Production Services by IBC Studio"
                  fill
          ...
          <div className={`spanel ${activeTab === 'video' ? 'active' : ''}`} style={{ display: activeTab === 'video' ? 'block' : 'none', width: '100%', paddingLeft: 'clamp(22px, 6vw, 80px)', paddingRight: 'clamp(22px, 6vw, 80px)' }}>
            <div className="sphdr reveal" style={{ width: '100%' }}>
              ...
              <div className="avwrap" style={{ width: '100%', marginTop: '30px', borderRadius: '16px', overflow: 'hidden', position: 'relative', aspectRatio: '16/9' }}>
                <Image 
                  src="https://firebasestorage.googleapis.com/v0/b/ibc-studio.appspot.com/o/Images%2FServices_main%2F2.%20video.webp?alt=media&token=a203112b-a071-42e3-9851-f951cc5275e0" 
                  alt="Video Production Services by IBC Studio"
                  fill
                  sizes="(max-width: 768px) 100vw, 800px"
                  style={{ objectFit: 'cover', transition: 'opacity 0.5s ease-in-out' }}
                  priority
          ...
          <div className={`spanel ${activeTab === 'photo' ? 'active' : ''}`} style={{ display: activeTab === 'photo' ? 'block' : 'none', width: '100%', paddingLeft: 'clamp(22px, 6vw, 80px)', paddingRight: 'clamp(22px, 6vw, 80px)' }}>
            <div className="sphdr reveal" style={{ width: '100%' }}>
              ...
              <div className="avwrap" style={{ width: '100%', marginTop: '30px', borderRadius: '16px', overflow: 'hidden', position: 'relative', aspectRatio: '16/9' }}>
                <Image 
                  src="https://firebasestorage.googleapis.com/v0/b/ibc-studio.appspot.com/o/Images%2FServices_main%2F3.%20photo.webp?alt=media&token=8026ae73-7413-42ee-a1af-669db332b958" 
                  alt="Photography Services by IBC Studio"
                  fill
                  sizes="(max-width: 768px) 100vw, 800px"
                  style={{ objectFit: 'cover', transition: 'opacity 0.5s ease-in-out' }}
                  priority
          ...
          <div className={`spanel ${activeTab === 'ai' ? 'active' : ''}`} style={{ display: activeTab === 'ai' ? 'block' : 'none', width: '100%', paddingLeft: 'clamp(22px, 6vw, 80px)', paddingRight: 'clamp(22px, 6vw, 80px)' }}>
            <div className="sphdr reveal" style={{ width: '100%' }}>
              ...
              <div className="avwrap" style={{ width: '100%', marginTop: '30px', borderRadius: '16px', overflow: 'hidden', position: 'relative', aspectRatio: '16/9' }}>
                <Image 
                  src="https://firebasestorage.googleapis.com/v0/b/ibc-studio.appspot.com/o/Images%2FServices_main%2F4.%20AI.webp?alt=media&token=1e3d4e0e-8fec-4b61-861f-f66f93d0196b" 
          ...
          <div className={`spanel ${activeTab === 'digital' ? 'active' : ''}`} style={{ display: activeTab === 'digital' ? 'block' : 'none', width: '100%', paddingLeft: 'clamp(22px, 6vw, 80px)', paddingRight: 'clamp(22px, 6vw, 80px)' }}>
            <div className="sphdr reveal" style={{ width: '100%' }}>
              ...
              <div style={{ width: '100%', marginTop: '30px', borderRadius: '16px', overflow: 'hidden', position: 'relative', aspectRatio: '16/9' }}>
                <Image 
                  src="https://firebasestorage.googleapis.com/v0/b/ibc-studio.appspot.com/o/Images%2FServices_main%2F5%20Digital.png?alt=media&token=e8009679-ecdc-4cea-8d70-4187edfbd5bc" 
                  alt="Digital & Development Services by IBC Studio"
                  fill
                  sizes="(max-width: 768px) 100vw, 800px"
                  unoptimized
                  style={{ objectFit: 'cover', transition: 'opacity 0.5s ease-in-out' }}
          ...
          <div className={`spanel ${activeTab === 'motion' ? 'active' : ''}`} style={{ display: activeTab === 'motion' ? 'block' : 'none', width: '100%', paddingLeft: 'clamp(22px, 6vw, 80px)', paddingRight: 'clamp(22px, 6vw, 80px)' }}>
            <div className="sphdr reveal" style={{ width: '100%' }}>
              ...
              <div className="avwrap" style={{ width: '100%', marginTop: '30px', borderRadius: '16px', overflow: 'hidden', position: 'relative', aspectRatio: '16/9' }}>
                <Image 
                  src="https://firebasestorage.googleapis.com/v0/b/ibc-studio.appspot.com/o/Images%2FServices_main%2F6.%20VR.webp?alt=media&token=3ffff4ed-13dc-431e-91ed-662ea0a32ee0" 
                  alt="Motion Graphics & VR/AR Services by IBC Studio"
                  fill
                  sizes="(max-width: 768px) 100vw, 800px"
                  style={{ objectFit: 'cover', transition: 'opacity 0.5s ease-in-out' }}
                  priority
