...
export default function Home() {
  ...
  // Trigger Intersection Observer for smooth reveal on scroll
  useEffect(() => {
    ...
    const observerOptions = {
      ...
      rootMargin: '0px 0px -60px 0px', // Triggers slightly before element enters view bounds
    ...
    const observer = new IntersectionObserver((entries) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          entry.target.classList.remove('in-view'); // Re-animates when scrolling back up
        }
      });
    }, observerOptions);
    ...
    <>
      ...
      <div className="page active" id="pg-home" ref={containerRef}>
        <div className="pw" style={{ width: '100%' }}>
          ...
          {/* HERO SECTION */}
          <section className="hero" style={{ width: '100%', paddingLeft: '20px', paddingRight: '20px' }}>
            ...
            <div className="hcontent" style={{ width: '100%', maxWidth: '800px', margin: '0 auto' }}>
              <div className="heb">UAE's Leading Media Production House</div>
              <h1 
                className="htag" 
                style={{ 
              ...
              <p className="hsub" style={{ width: '100%', wordBreak: 'break-word', overflowWrap: 'break-word' }}>
              ...
              <div className="hact" style={{ display: 'flex', gap: '14px', flexWrap: 'wrap', justifyContent: 'center', width: '100%' }}>
        ...
        <div className="tcard">
          ...
          <section className="sec reveal" style={{ width: '100%' }}>
            ...
            <div className="srv-grid" style={{ width: '100%' }}>
              <Link href="/services#pg-services" className="srv-card" style={{ textDecoration: 'none', display: 'block' }}>
          ...
          <section className="sec-sm reveal" style={{ width: '100%' }}>
            <div className="intel-strip" style={{ width: '100%' }}>
              <div>
                ...
                <p style={{ wordBreak: 'break-word' }}>IBC Intelligence helps businesses identify where AI creates measurable operational leverage across productivity, speed, reporting, decision support, and execution, then turns those opportunities into practical systems aligned with how teams actually work.</p>
                <div style={{ marginTop: '22px' }}><Link href="/ibc-intelligence" className="btn-p">Book a Consultancy →</Link></div>
              </div>
          ...
          <section className="sec reveal" style={{ background: 'var(--bg2)', width: '100%' }}>
            <div style={{ textAlign: 'center', width: '100%' }}>
              ...
              <h2 className="title" style={{ wordBreak: 'break-word' }}>Our 4-Step Process</h2>
              <p className="desc desc-c" style={{ width: '100%', wordBreak: 'break-word' }}>From your first idea to final delivery, a streamlined and collaborative approach focused on clarity and results.</p>
            </div>
