      ...
      >
        ...
        <div className="chat-body" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <div className="chat-actions" style={{ position: 'relative', zIndex: 3 }}>
            <a href="/services#pg-services" className="chat-chip" onClick={() => setIsActive(false)}>I need production services</a>
            <a href="/ibc-intelligence#pg-intel" className="chat-chip" onClick={() => setIsActive(false)}>I want AI consultancy</a>
            <a href="/contact#pg-contact" className="chat-chip" onClick={() => setIsActive(false)}>I want to request a quote</a>
          </div>
          <a 
