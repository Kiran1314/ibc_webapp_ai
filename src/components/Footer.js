    ...
    <footer>
      <div className="ft-grid">
        <div className="ft-brand">
          ...
          <p>Dubai-based media production house delivering audio, video, photography, AI-powered content, and digital media solutions with over 19 years of experience.</p>
        ...
        <div className="ft-col">
          ...
          <div style={{ marginTop: '14px' }}>
            <Link href="/contact#pg-contact" className="btn-p" style={{ fontSize: '12.5px', padding: '10px 18px' }}>Get In Touch →</Link>
          </div>
        </div>
      </div>
